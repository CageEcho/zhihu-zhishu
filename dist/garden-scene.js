...
function renderTags(){
 let h='';
 if(stage==='seed')return '<div class="callout seed-label"><strong><span class="mini-line"></span>轻触种子，导入收藏</strong><small>你的第一棵知树，从这里开始</small></div>'+hit(735,639,'seed',0,'点击发光种子，导入收藏',110,110).replace('class="g7-hit"','class="g7-hit seed-hover-target"')+'<span class="seed-cursor" aria-hidden="true"><svg viewBox="0 0 32 38"><path d="M12.7 18.2V6.9c0-1.9 1.1-3.2 2.8-3.2s2.7 1.3 2.7 3.2v8.3-2.7c0-1.8 1-3 2.6-3s2.6 1.2 2.6 3v3.4-1.8c0-1.7.9-2.8 2.4-2.8 1.6 0 2.5 1.2 2.5 2.9v8.5c0 6.9-4.3 11.2-10.7 11.2h-1.1c-3.8 0-6.8-1.7-8.8-5L3.4 22c-.9-1.5-.6-3.1.8-4 1.2-.8 2.6-.5 3.6.6l4.9 5.3"/></svg></span><section class="seed-hover-card" aria-label="收藏导入预览"><div class="seed-card-kicker"><span class="seed-card-icon"><svg viewBox="0 0 28 28"><path d="M21.5 6.5C13.1 6.9 7.8 11 7.4 18.2c4.1.5 7.6-1.1 10-4.6M7.5 18.1c-.7 1.2-1.1 2.4-1.2 3.6"/></svg></span><span>收藏 · 生长的起点</span><button type="button" data-garden-action="seed-hover-close" aria-label="关闭预览">×</button></div><h2>把你的收藏，种在这里。</h2><p class="seed-card-lead">收藏的内容与来源，会成为这棵树的根系。</p><div class="seed-card-tabs"><span class="selected">已有收藏</span><span>粘贴内容</span><span>导入文件</span></div><p class="seed-card-help">选择 1–5 条内容，每条收藏对应一条主根。</p><div class="seed-card-list"><article class="selected"><i><svg viewBox="0 0 18 18"><path d="m4 9 3.1 3.2L14 5.5"/></svg></i><div><b>将 AI 素养纳入大学教育</b><small>演示收藏 · 知乎公开资料</small><p>不仅要会生成内容，还要判断可靠性、识别幻觉、核实来源，重视推理和使用过程。</p></div></article><article><i></i><div><b>用AI写作业，提交前需做事实核查</b><small>演示收藏 · 知乎公开资料</small><p>将 AI 输出拆成可验证的陈述，再到权威来源逐条确认，避免虚构文献混入作业。</p></div></article><article><i></i><div><b>大学严查AI，启动过程性监管</b><small>演示收藏 · 知乎公开资料</small><p>保留写作过程、修改轨迹和来源记录，让学生能够证明自己的真实投入。</p></div></article></div><div class="seed-card-actions"><span class="seed-card-count">已选 1 / 5</span><button type="button" data-garden-action="seed-hover-close" class="seed-card-back">回到树上</button><button type="button" data-garden-action="seed-hover-import" class="seed-card-primary">导入，让它生根 <span>→</span></button></div></section>';
