...
function node(x,y,color='#b4ce81'){return `<circle cx="${x}" cy="${y}" r="12" fill="${color==='#7a5a3d'?'#fff4e6':'#f8ffed'}" opacity=".35"/><circle cx="${x}" cy="${y}" r="6" fill="${color}" stroke="#fff" stroke-width="2.5"/>`;}
